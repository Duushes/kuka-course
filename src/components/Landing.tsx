...
const modules = [
  ...
  },
  {
    ...
    desc: 'Готовые решения: палеты, сварка, vision',
    icon: (
      <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
...
const learnPoints = [
  ...
  <>Разбирать коды ошибок <strong className="text-foreground">KSS</strong> и троублшутить через <strong className="text-foreground">Xpert</strong></>,
];
    ...
    <div className="grid sm:grid-cols-2 gap-3 mt-4">
      ...
      <div className="p-4 rounded-xl bg-card border border-border/50">
        ...
        <div className="space-y-1.5 text-xs text-muted-foreground">
          ...
          <div><strong className="text-foreground font-mono">CIRC</strong> &mdash; дуга через aux-point</div>
